            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="date" name="tanggal" placeholder="Masukkan Tanggal" autocomplete="off" required="">
                </div>
              </div>
            </div>
...
<!-- <script src="<?php //echo base_url()
                  ?>assets/jquery.min.js" type="text/javascript"></script> -->
